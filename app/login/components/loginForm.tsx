        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link
                  href="/forgotPassword"
                  className="font-medium text-[#004953] hover:text-[#003a44] transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-[#004953] hover:bg-[#003a44] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#004953] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
              {isLoading ? (
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-center text-sm text-gray-600">
              Need help? Contact{" "}
              <a
                href="mailto:support@fleetco.com"
                className="font-medium text-[#004953] hover:text-[#003a44]"
              >
                support@fleetco.com
              </a>
            </p>
